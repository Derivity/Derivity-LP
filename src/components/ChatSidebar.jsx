...
import { Plus, Menu, X, Trash2, MessageCircle } from 'lucide-react'
    ...
    <>
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="m-3 mt-4 px-4 py-2.5 rounded-lg flex items-center justify-center gap-2 transition-colors duration-200 font-medium text-sm"
          style={{
        ...
        {/* Divider */}
        <div className="px-3 h-px bg-gradient-to-r from-transparent via-white/[0.08] to-transparent" />
        ...
        <div className="border-t border-white/[0.055] p-3 space-y-2">
          <div className="flex justify-center">
            <img src="/logo.svg" alt="Derivity logo" className="w-24 h-12 object-contain opacity-90" />
          </div>
